 ...
 * @param  {Number} total Number of issued certificates
 * @return {Number}       Index of a matching certificate in ordered Array
 */
exports.findCertificateIndex = function findCertificateIndex(frn, total) {
    return Math.floor(frn / MAX_RANDOM * total);
};
